                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                <form class="needs-validation" method="POST" action="/admin/update-user/{{$user->id}}" enctype="multipart/form-data">
                                      {{ csrf_field() }}
                                        <div class="row">
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 ">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom02" name="mobile_number" placeholder="Mobile Number" value="{{ $user->mobile_number }}"  required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">    
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="email" class="form-control" id="validationCustomUsername" placeholder="Email" name="email" aria-describedby="inputGroupPrepend" value="{{ $user->email }}" required>
                                        ...
                                        <div class="form-row">
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom03" name="company_name" placeholder="Company Name" value="{{ $user->company_name }}">
                                                <div class="invalid-feedback">
                                                    Company Name
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom04" name="company_resale_license_number" placeholder="Company Resale License Number" value="{{ $user->company_resale_license_number }}">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-row">    
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                                                ...
                                                <input type="email" class="form-control" id="validationCustom05" placeholder="Company Email" name="company_email" value="{{ $user->company_email }}">
                                                <div class="invalid-feedback">
                                                    Company Email
                                                </div>
                                            </div>
                                             <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom05" placeholder="Company Number" name="company_number" value="{{ $user->company_number }}" >
                                                <div class="invalid-feedback">
                                                    Company Number
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-2">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom05" placeholder="Company Address" name="company_address" value="{{ $user->company_address }}" >
                                                <div class="invalid-feedback">
                                                    Company Address
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="exampleFormControlTextarea1" name="more_info" rows="3">{{ $user->more_info }}</textarea>
                                        </div>
                                        <div class="form-row"> 
